      ...
      <Grid container spacing={2} alignItems="stretch" sx={{ maxWidth: 1200, mx: 'auto' }}>
        {visible.map((p) => (
          <Grid key={p.id} item xs={12} sm={6} md={3} sx={{ display: 'flex' }}>
            <Card sx={{ p: 1.5, border: '1px solid #eee', borderRadius: 2, height: '100%', display: 'flex', flexDirection: 'column', width: '100%', minHeight: 350 }}>
              <Box sx={{ position: 'relative' }}>
                ...
                <CardMedia component="img" image={p.image} alt={p.name} sx={{ height: 180, objectFit: 'contain' }} />
              </Box>
