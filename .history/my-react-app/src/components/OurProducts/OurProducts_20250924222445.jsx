            ...
            >
              <Box sx={{ position: "relative", height: 200, display: "flex", alignItems: "center", justifyContent: "center", bgcolor: "#fafafa" }}>
                ...
                <CardMedia
                  ...
                  image={p.image}
                  alt={p.name}
                  sx={{ height: 160, width: 160, objectFit: "cover", borderRadius: 1 }}
                />
              </Box>
              <CardContent sx={{ textAlign: "center", flexGrow: 1, display: "flex", flexDirection: "column", justifyContent: "space-between", height: 120, padding: "16px 16px 8px 16px" }}>
                <Box sx={{ height: 60, display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  <Typography variant="caption" sx={{ color: "#8a8a8a", lineHeight: 1.2 }}>
                    {p.category}
                  </Typography>
                  <Typography
                    variant="subtitle1"
                    sx={{ fontWeight: 700, whiteSpace: "pre-line", fontSize: "0.9rem", lineHeight: 1.3, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}
                  >
                    {p.name}
                  </Typography>
                </Box>
