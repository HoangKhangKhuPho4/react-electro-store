        ...
        <div className="about-content" style={{ marginTop: "30px" }}>
          <section style={{ marginBottom: "40px" }}>
            ...
            <p style={{ lineHeight: "1.6", marginTop: "15px" }}>
              Electro Store has been serving customers with quality electronics
              for over a decade. We pride ourselves on offering the latest
              technology at competitive prices. Our journey began in 2010 with a
